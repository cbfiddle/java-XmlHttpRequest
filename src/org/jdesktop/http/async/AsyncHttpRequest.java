...
public class AsyncHttpRequest extends AbstractBean implements Constants {
    ...
    public void setRequestHeader(String header, String value) {
        ...
        if (header.equalsIgnoreCase(HEADER_ACCEPT_CHARSET) ||
            header.equalsIgnoreCase(HEADER_ACCEPT_ENCODING) ||
            header.equalsIgnoreCase(HEADER_CONTENT_LENGTH) ||
            header.equalsIgnoreCase(HEADER_EXPECT) ||
            header.equalsIgnoreCase(HEADER_DATE) ||
            header.equalsIgnoreCase(HEADER_HOST) ||
            header.equalsIgnoreCase(HEADER_KEEP_ALIVE) ||
            header.equalsIgnoreCase(HEADER_REFERER) ||
            header.equalsIgnoreCase(HEADER_TE) ||
            header.equalsIgnoreCase(HEADER_TRAILER) ||
            header.equalsIgnoreCase(HEADER_TRANSFER_ENCODING) ||
            header.equalsIgnoreCase(HEADER_UPGRADE)) {
            
            //ignore the header
        }
        
        if (header.equalsIgnoreCase(HEADER_AUTHORIZATION) ||
            header.equalsIgnoreCase(HEADER_CONTENT_BASE) ||
            header.equalsIgnoreCase(HEADER_CONTENT_LOCATION) ||
            header.equalsIgnoreCase(HEADER_CONTENT_MD5) ||
            header.equalsIgnoreCase(HEADER_CONTENT_RANGE) ||
            header.equalsIgnoreCase(HEADER_CONTENT_TYPE) ||
            header.equalsIgnoreCase(HEADER_CONTENT_VERSION) ||
            header.equalsIgnoreCase(HEADER_DELTA_BASE) ||
            header.equalsIgnoreCase(HEADER_DEPTH) ||
            header.equalsIgnoreCase(HEADER_DESTINATION) ||
            header.equalsIgnoreCase(HEADER_E_TAG) ||
            header.equalsIgnoreCase(HEADER_EXPECT) ||
            header.equalsIgnoreCase(HDAER_FROM) ||
            header.equalsIgnoreCase(HEADER_IF_MODIFIED_SINCE) ||
            header.equalsIgnoreCase(HEADER_IF_RANGE) ||
            header.equalsIgnoreCase(HEADER_IF_UNMODIFIED_SINCE) ||
            header.equalsIgnoreCase(HEADER_MAX_FORWARDS) ||
            header.equalsIgnoreCase(HEADER_MIME_VERSION) ||
            header.equalsIgnoreCase(HEADER_OVERWRITE) ||
            header.equalsIgnoreCase(HEADER_PROXY_AUTHORIZATION) ||
            header.equalsIgnoreCase(HEADER_SOAP_ACTION) ||
            header.equalsIgnoreCase(HEADER_TIMEOUT)) {
